...
public class EnemySecondScript : MonoBehaviour
{
    ...
    void Shoot()
    {
        ...
        Vector3 shootingV = new Vector3(trans.position.x - .35f, trans.position.y +.5f, trans.position.z + 0.5f);

        GameObject a = Instantiate(arrowPrefab, shootingV, trans.rotation) as GameObject;
        a.transform.Rotate(-20f, 0f, 0f);
        Rigidbody b = a.GetComponent<Rigidbody>();
        b.velocity = trans.forward * 40f;
    }
